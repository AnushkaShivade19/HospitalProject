    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField()),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.patient')),
                ('referred_doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referred_doctor', to='accounts.doctor')),
                ('referring_doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referring_doctor', to='accounts.doctor')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
